...
interface MethodHandlerSchemas<BodySchema extends Schema, ParamsSchema extends Schema, QuerySchema extends Schema> {
    body?: BodySchema;
    params?: ParamsSchema;
    query?: QuerySchema;
}
export declare type MethodHandlerConfig<BodySchema extends Schema, ParamsSchema extends Schema, QuerySchema extends Schema> = {
